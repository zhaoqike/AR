...
ARDrawingContext::ARDrawingContext(string windowName, Size frameSize, const CameraCalibration& c)
...
void ARDrawingContext::init(string windowName, Size frameSize, const CameraCalibration& c)
{
	m_isTextureInitialized=false;
	m_calibration=c;
	m_windowName=windowName;
